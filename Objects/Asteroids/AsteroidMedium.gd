...
func _ready() -> void:
	rng.randomize()
	var asteroids = [Globals.sprite_asteroid_m1, Globals.sprite_asteroid_m2, Globals.sprite_asteroid_m3, Globals.sprite_asteroid_m4, Globals.sprite_asteroid_m5]
...
# When destroyed, instance smaller asteroids
	_spawn_asteroid_smalls(randf_range(1, 2))

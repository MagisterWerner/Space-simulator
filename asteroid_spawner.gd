...
@export var min_asteroids_per_cell = 2  # Minimum asteroids per cell
@export var max_asteroids_per_cell = 15  # Maximum asteroids per cell (increased for higher density)
